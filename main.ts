...
const mainUser: User = { id: 5, name: "Elmurod", salary: totalSalary };

console.log(mainUser);

//////////////HOMEWORK 4///////////////////

const numbers: number[] = [1, 2, 2, 3, 4, 4, 5, 6, 7, 7, 8, 9, 10, 10];

const uniqueNumbers = numbers.filter(
  (num, index, arr) => arr.indexOf(num) === arr.lastIndexOf(num)
);
...
const uniqueUsersMap = new Map<number, User5>();
